...
if __name__ == '__main__':
    ...
    print(tokenize.hanlp_token('众所周知，长时间以来，加入欧盟和北约，就是乌克兰政府的心愿。过去这段时间里，为了加入北约和欧盟，乌克兰政府曾多次向其喊话，要求其同意乌克兰的加入。而自俄乌冲突正式开始后，乌克兰总统泽连斯基喊话欧盟与北约的频率更是越发频繁，就在前几日，泽连斯基更是发表了视频讲话，并在视频讲话中呼吁欧盟启动特殊程序，立即同意乌克兰加入欧盟。'))
